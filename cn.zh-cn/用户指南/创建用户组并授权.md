# 创建用户组并授权<a name="zh-cn_topic_0046611269"></a>

管理员可以创建用户组，并给用户组授予策略，然后将用户加入用户组，使得用户组中的用户获得策略定义的权限。IAM预置了各服务的常用权限，例如管理员权限、只读权限，管理员可以直接使用这些系统策略给用户组授权，授权后，用户就可以基于权限对云服务进行操作。**如需查看所有云服务的系统策略，请参见：[权限策略](https://support.huaweicloud.com/usermanual-permissions/zh-cn_topic_0063498930.html)**。
...
-   规划用户组需要的权限，IAM的权限如[表1](#table037948173715)所示，**如需了解其他服务的权限，请参考：[权限策略](https://support.huaweicloud.com/usermanual-permissions/zh-cn_topic_0063498930.html)**。
-   如果给用户组授予RBAC策略，需要确认是否有依赖的策略，如果有，需要同时[设置依赖的权限](依赖权限的授权方法.md)，授予的RBAC权限才会生效。

**表 1**  IAM系统策略

<a name="table037948173715"></a>
<table><thead align="left"><tr id="row83713480378"><th class="cellrowborder" valign="top" width="20.11201120112011%" id="mcps1.2.4.1.1"><p id="p437648113711"><a name="p437648113711"></a><a name="p437648113711"></a>策略名称</p>
</th>
<th class="cellrowborder" valign="top" width="22.372237223722376%" id="mcps1.2.4.1.2"><p id="p238134813377"><a name="p238134813377"></a><a name="p238134813377"></a>授权区域</p>
</th>
<th class="cellrowborder" valign="top" width="57.515751575157516%" id="mcps1.2.4.1.3"><p id="p1038164873714"><a name="p1038164873714"></a><a name="p1038164873714"></a>操作权限</p>
</th>
</tr>
</thead>
<tbody><tr id="row133814803718"><td class="cellrowborder" valign="top" width="20.11201120112011%" headers="mcps1.2.4.1.1 "><p id="p4381548183719"><a name="p4381548183719"></a><a name="p4381548183719"></a>Security Administrator</p>
</td>
<td class="cellrowborder" valign="top" width="22.372237223722376%" headers="mcps1.2.4.1.2 "><p id="p16381748133711"><a name="p16381748133711"></a><a name="p16381748133711"></a>全局区域</p>
</td>
<td class="cellrowborder" valign="top" width="57.515751575157516%" headers="mcps1.2.4.1.3 "><p id="p1859825621616"><a name="p1859825621616"></a><a name="p1859825621616"></a>IAM的管理员权限，可以对IAM执行所有操作，包括但不限于：</p>
...
<td class="cellrowborder" valign="top" width="22.372237223722376%" headers="mcps1.2.4.1.2 "><p id="p3381648173714"><a name="p3381648173714"></a><a name="p3381648173714"></a>全局区域</p>
</td>
<td class="cellrowborder" valign="top" width="57.515751575157516%" headers="mcps1.2.4.1.3 "><p id="p274618358480"><a name="p274618358480"></a><a name="p274618358480"></a>切换角色权限，该权限不能使用IAM服务，仅能切换角色至委托方账号中，访问授权的服务。</p>
</td>
</tr>
</tbody>
</table>
...
3.  在统一身份认证服务，左侧导航窗格中，单击“用户组”\>“创建用户组”。
    ...
    ![](figures/zh-cn_image_0170934012.png)

      

4.  在“创建用户组”界面，输入“用户组名称”，例如“开发人员组”。

    ![](figures/zh-cn_image_0170934013.png)
...
1.  在用户组列表中，单击新建用户组“开发人员组”，右侧的“权限配置”。
    ...
    ![](figures/zh-cn_image_0170934014.png)

2.  在用户组权限页签中，单击列表左上方的“配置权限”。

    **图 1**  配置权限<a name="fig17511648191515"></a>  
    ![](figures/配置权限.png "配置权限")

3.  IAM提供“策略视图”和“项目视图”两种权限配置方式。
    -   策略视图：您可以为一个策略同时配置多个项目。
        1.  在右侧滑窗中，单击“策略视图”。

            **图 2**  选择策略视图<a name="fig7946810527"></a>  
            ![](figures/选择策略视图.png "选择策略视图")

        2.  在搜索框中搜索云服务的英文缩写，并在搜索结果中勾选需要授权的策略。

            **图 3**  勾选策略<a name="fig1212321312710"></a>  
            ![](figures/勾选策略.png "勾选策略")

        3.  在已勾选策略的“项目\[所属区域\]”下拉框中，选择需要给该策略授权的项目（可选择多个项目）。
        4.  单击“确定”，完成用户组授权。

    -   项目视图：您可以为一个项目同时配置多个策略。
        1.  在右侧滑窗中，单击“项目视图”。

            **图 4**  选择项目视图<a name="fig968552517223"></a>  
            ![](figures/选择项目视图.png "选择项目视图")

        2.  选择需要授权的“项目\[所属区域\]”，单击右侧的“选择策略”。

            **图 5**  选择策略<a name="fig623498257"></a>  
            ...
            >**华为云各区域之间权限相互隔离，授予的权限仅在设置的区域生效。**例如在“华北-北京四”授予弹性云服务器ECS的权限，则用户仅能访问"华北-北京四”区域的ECS，如果尝试访问其他区域的ECS，系统将会提示没有权限。如果需要给IAM用户授予多个区域的权限，请分别单击需要授权区域右侧的“设置策略”进行授权。  

        3.  在“选择策略”弹窗中，勾选需要给此项目授权的策略。可以在搜索框中搜索云服务的英文缩写，并在搜索结果中勾选需要授权的策略。
        4.  单击“确定”，完成用户组授权。



[表2](#table24561510152720)为常用权限，完整的权限列表请参见：[权限策略](https://support.huaweicloud.com/usermanual-permissions/zh-cn_topic_0063498930.html)。
...
<td class="cellrowborder" valign="top" width="26.487351264873517%" headers="mcps1.2.5.1.2 "><p id="p0441181014273"><a name="p0441181014273"></a><a name="p0441181014273"></a>Full Access</p>
</td>
<td class="cellrowborder" valign="top" width="31.356864313568643%" headers="mcps1.2.5.1.3 "><p id="p1944151022717"><a name="p1944151022717"></a><a name="p1944151022717"></a>支持细粒度授权服务的所有权限</p>
</td>
...
<td class="cellrowborder" valign="top" width="26.487351264873517%" headers="mcps1.2.5.1.2 "><p id="p7443101022718"><a name="p7443101022718"></a><a name="p7443101022718"></a>ECS Admin</p>
</td>
...
<tr id="row744719109275"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p14447410142711"><a name="p14447410142711"></a><a name="p14447410142711"></a>CCE Admin</p>
</td>
...
<tr id="row144719106274"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p6447121062713"><a name="p6447121062713"></a><a name="p6447121062713"></a>CCI Admin</p>
</td>
...
<tr id="row17450210202719"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p11449181042711"><a name="p11449181042711"></a><a name="p11449181042711"></a>BMS Admin</p>
</td>
...
<tr id="row1745016104273"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p4450161013271"><a name="p4450161013271"></a><a name="p4450161013271"></a>IMS Admin</p>
</td>
...
<tr id="row184511510162711"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p104509104272"><a name="p104509104272"></a><a name="p104509104272"></a>AutoScaling Admin</p>
</td>
...
<td class="cellrowborder" valign="top" width="26.487351264873517%" headers="mcps1.2.5.1.2 "><p id="p1451151020271"><a name="p1451151020271"></a><a name="p1451151020271"></a>VPC Admin</p>
</td>
...
<tr id="row8451131072716"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p64513101274"><a name="p64513101274"></a><a name="p64513101274"></a>ELB Admin</p>
</td>
...
<td class="cellrowborder" valign="top" width="26.487351264873517%" headers="mcps1.2.5.1.2 "><p id="p1452310162719"><a name="p1452310162719"></a><a name="p1452310162719"></a>RDS Admin</p>
</td>
...
<tr id="row114527107272"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p853463810246"><a name="p853463810246"></a><a name="p853463810246"></a>DDS Admin</p>
</td>
...
<tr id="row54531010122718"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p945218103277"><a name="p945218103277"></a><a name="p945218103277"></a>DDM Admin</p>
</td>
...
>![](public_sys-resources/icon-note.gif) **说明：**   
>更多有关权限的使用建议请参见：[多运维人员权限设置案例](https://support.huaweicloud.com/bestpractice-iam/iam_0430.html)、[依赖权限的授权方法](依赖权限的授权方法.md)、[自定义策略使用样例](自定义策略使用样例.md)。  
