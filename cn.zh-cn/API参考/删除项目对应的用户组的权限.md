# 删除项目对应的用户组的权限<a name="ZH-CN_TOPIC_0110485103"></a>
...
-   Request Header参数说明
    ...
    <td class="cellrowborder" valign="top" width="44.21%" headers="mcps1.1.5.1.4 "><p id="p35594087111810"><a name="p35594087111810"></a><a name="p35594087111810"></a>已认证的拥有Security Administrator权限的token。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
## 响应<a name="section93300393113"></a>
