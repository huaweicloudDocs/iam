...
该接口可以用于[管理员](https://support.huaweicloud.com/usermanual-iam/iam_01_0001.html)  查询OpenID Connect身份提供商配置。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="p081515154426"><a name="p081515154426"></a><a name="p081515154426"></a>拥有Security Administrator权限的token。</p>
</td>
</tr>
</tbody>
</table>
