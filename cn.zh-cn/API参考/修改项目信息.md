...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482445_p9210164063918"><a name="zh-cn_topic_0221482445_p9210164063918"></a><a name="zh-cn_topic_0221482445_p9210164063918"></a>待修改的项目ID，获取方式请参见：<a href="获取IAM用户-项目-用户组的名称和ID.md">获取IAM用户、项目、用户组的名称和ID</a>。</p>
</td>
</tr>
</tbody>
</table>
