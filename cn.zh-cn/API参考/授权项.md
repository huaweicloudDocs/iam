# 授权项<a name="ZH-CN_TOPIC_0217776802"></a>
...
<td class="cellrowborder" valign="top" width="53.615361536153614%" headers="mcps1.1.4.1.3 "><p id="p360972182018"><a name="p360972182018"></a><a name="p360972182018"></a><a href="获取用户Token.md">POST /v3/auth/tokens</a></p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p1260014583373"><a name="p1260014583373"></a><a name="p1260014583373"></a><a href="查询用户列表.md">GET /v3/users</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p66011581379"><a name="p66011581379"></a><a name="p66011581379"></a><a href="查询用户详情(包含邮箱和手机号码).md">GET /v3.0/OS-USER/users/{user_id}</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p5877171444015"><a name="p5877171444015"></a><a name="p5877171444015"></a><a href="查询用户详情.md">GET /v3/users/{user_id}</a></p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p6419121144112"><a name="p6419121144112"></a><a name="p6419121144112"></a><a href="查询用户所属用户组.md">GET /v3/users/{user_id}/groups</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p141884274115"><a name="p141884274115"></a><a name="p141884274115"></a><a href="查询用户组所包含的用户.md">GET /v3/groups/{group_id}/users</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p12139725104212"><a name="p12139725104212"></a><a name="p12139725104212"></a><a href="查询用户组.md">GET /v3/groups{?domain_id,name}</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p121401253428"><a name="p121401253428"></a><a name="p121401253428"></a><a href="查询用户是否在用户组中.md">HEAD /v3/groups/{group_id}/users/{user_id}</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.655265526552654%" headers="mcps1.1.4.1.3 "><p id="p354517172468"><a name="p354517172468"></a><a name="p354517172468"></a><a href="查询自定义角色列表.md">GET /v3.0/OS-ROLE/roles</a></p>
</td>
</tr>
