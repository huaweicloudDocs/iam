# 获取委托Token<a name="iam_30_0003"></a>

## 功能介绍<a name="zh-cn_topic_0221482426_section1799876182019"></a>

该接口可以用于获取委托方的token。

例如：A帐号希望B帐号管理自己的某些资源，所以A帐号创建了委托给B帐号，则A帐号为委托方，B帐号为被委托方。那么B帐号可以通过该接口获取委托token。B帐号仅能使用该token管理A帐号的委托资源，不能管理自己帐号中的资源。如果B帐号需要管理自己帐号中的资源，则需要获取自己的用户token。详情请参考：[委托其他华为云帐号管理资源](https://support.huaweicloud.com/usermanual-iam/iam_06_0001.html)。
...
## 调试<a name="section79701410185315"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=IAM&api=KeystoneCreateAgencyToken)中调试该接口。
...
<th class="cellrowborder" valign="top" width="10.290000000000001%" id="mcps1.2.5.1.2"><p id="zh-cn_topic_0221482426_p1123742020"><a name="zh-cn_topic_0221482426_p1123742020"></a><a name="zh-cn_topic_0221482426_p1123742020"></a>是否必选</p>
</th>
<th class="cellrowborder" valign="top" width="19.71%" id="mcps1.2.5.1.3"><p id="zh-cn_topic_0221482426_p821372202"><a name="zh-cn_topic_0221482426_p821372202"></a><a name="zh-cn_topic_0221482426_p821372202"></a>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="10.290000000000001%" headers="mcps1.2.5.1.2 "><p id="zh-cn_topic_0221482426_p2020710202"><a name="zh-cn_topic_0221482426_p2020710202"></a><a name="zh-cn_topic_0221482426_p2020710202"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="19.71%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0221482426_p9313717201"><a name="zh-cn_topic_0221482426_p9313717201"></a><a name="zh-cn_topic_0221482426_p9313717201"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="10.290000000000001%" headers="mcps1.2.5.1.2 "><p id="zh-cn_topic_0221482426_p124170209"><a name="zh-cn_topic_0221482426_p124170209"></a><a name="zh-cn_topic_0221482426_p124170209"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="19.71%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0221482426_p12447162020"><a name="zh-cn_topic_0221482426_p12447162020"></a><a name="zh-cn_topic_0221482426_p12447162020"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482426_p1545732010"><a name="zh-cn_topic_0221482426_p1545732010"></a><a name="zh-cn_topic_0221482426_p1545732010"></a>被委托方B帐号中的IAM用户具有Agent Operator权限的token。</p>
</td>
</tr>
</tbody>
</table>
...
<tbody><tr id="row869114107464"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0221482426_p713137142011"><a name="zh-cn_topic_0221482426_p713137142011"></a><a name="zh-cn_topic_0221482426_p713137142011"></a>domain_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="p1060616295917"><a name="p1060616295917"></a><a name="p1060616295917"></a>委托方A的帐号ID。“domain_id”与“domain_name”至少填写一个，建议选择“domain_id”。</p>
<p id="zh-cn_topic_0221482426_p141311712018"><a name="zh-cn_topic_0221482426_p141311712018"></a><a name="zh-cn_topic_0221482426_p141311712018"></a>委托方A可以参考<a href="获取帐号-IAM用户-项目-用户组-区域-委托的名称和ID.md">获取帐号、IAM用户、项目、用户组、区域、委托的名称和ID</a>获取帐号ID。</p>
</td>
</tr>
<tr id="zh-cn_topic_0221482426_row01118712017"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p id="zh-cn_topic_0221482426_p012167182014"><a name="zh-cn_topic_0221482426_p012167182014"></a><a name="zh-cn_topic_0221482426_p012167182014"></a>domain_name</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="p57065415917"><a name="p57065415917"></a><a name="p57065415917"></a>委托方A的帐号名称。“domain_id”与“domain_name”至少填写一个，建议选择“domain_id”。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482426_p12134715209"><a name="zh-cn_topic_0221482426_p12134715209"></a><a name="zh-cn_topic_0221482426_p12134715209"></a>委托方A创建的委托名称，获取方式请参见：<a href="获取帐号-IAM用户-项目-用户组-区域-委托的名称和ID.md">获取帐号、IAM用户、项目、用户组、区域、委托的名称和ID</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482426_p1220374203"><a name="zh-cn_topic_0221482426_p1220374203"></a><a name="zh-cn_topic_0221482426_p1220374203"></a>委托方A的帐号ID，获取方式请参见：<a href="获取帐号-IAM用户-项目-用户组-区域-委托的名称和ID.md">获取帐号、IAM用户、项目、用户组、区域、委托的名称和ID</a>。id和name，二选一即可。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482426_p8208716203"><a name="zh-cn_topic_0221482426_p8208716203"></a><a name="zh-cn_topic_0221482426_p8208716203"></a>委托方A的帐号名，获取方式请参见：<a href="获取帐号-IAM用户-项目-用户组-区域-委托的名称和ID.md">获取帐号、IAM用户、项目、用户组、区域、委托的名称和ID</a>。id和name，二选一即可。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482426_p02217202015"><a name="zh-cn_topic_0221482426_p02217202015"></a><a name="zh-cn_topic_0221482426_p02217202015"></a>委托方A项目的ID，获取方式请参见：<a href="获取帐号-IAM用户-项目-用户组-区域-委托的名称和ID.md">获取帐号、IAM用户、项目、用户组、区域、委托的名称和ID</a>。id和name，二选一即可。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0221482426_p2023127142018"><a name="zh-cn_topic_0221482426_p2023127142018"></a><a name="zh-cn_topic_0221482426_p2023127142018"></a>委托方A项目的名称，获取方式请参见：<a href="获取帐号-IAM用户-项目-用户组-区域-委托的名称和ID.md">获取帐号、IAM用户、项目、用户组、区域、委托的名称和ID</a>。id和name，二选一即可。</p>
</td>
</tr>
</tbody>
</table>
    ...
    ```
    {
        "auth": {
            "identity": {
                ...
                "assume_role": {
                    "domain_name": "IAMDomainA",                //委托方IAM用户A所属帐号名称
...
-   由被委托方B（帐号名为IAMDomainB）中的IAM用户B（用户名IAMUserB，请求头中的X-Auth-Token字段需要填写IAMUserB的用户token，且该token需要具有Agent Operator权限），获取委托方A（帐号名为IAMDomainA）创建的委托名为IAMAgency，作用范围为委托方A整个帐号的token。
    ...
    ```
    {
        "auth": {
            ...
            "scope": {
                "domain": {
                    "name": "IAMDomainA"                        //委托方IAM用户A所属帐号名称
                }
            }
        }
    }
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p133111717206"><a name="zh-cn_topic_0221482426_p133111717206"></a><a name="zh-cn_topic_0221482426_p133111717206"></a>委托方A的帐号信息。如果获取token时请求体中scope参数设置为domain，则返回该字段。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p132517192010"><a name="zh-cn_topic_0221482426_p132517192010"></a><a name="zh-cn_topic_0221482426_p132517192010"></a>被委托方B的帐号信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p23251273209"><a name="zh-cn_topic_0221482426_p23251273209"></a><a name="zh-cn_topic_0221482426_p23251273209"></a>被委托方B的帐号名称。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p17325177152016"><a name="zh-cn_topic_0221482426_p17325177152016"></a><a name="zh-cn_topic_0221482426_p17325177152016"></a>被委托方B的帐号ID。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p123268716208"><a name="zh-cn_topic_0221482426_p123268716208"></a><a name="zh-cn_topic_0221482426_p123268716208"></a>委托方A的帐号名称。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p83262070207"><a name="zh-cn_topic_0221482426_p83262070207"></a><a name="zh-cn_topic_0221482426_p83262070207"></a>委托方A的帐号ID。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p18327107192019"><a name="zh-cn_topic_0221482426_p18327107192019"></a><a name="zh-cn_topic_0221482426_p18327107192019"></a>委托方A的帐号信息。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p1432757102011"><a name="zh-cn_topic_0221482426_p1432757102011"></a><a name="zh-cn_topic_0221482426_p1432757102011"></a>委托方A的帐号名称。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p93271974206"><a name="zh-cn_topic_0221482426_p93271974206"></a><a name="zh-cn_topic_0221482426_p93271974206"></a>委托方A的帐号ID。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p9328127152018"><a name="zh-cn_topic_0221482426_p9328127152018"></a><a name="zh-cn_topic_0221482426_p9328127152018"></a>委托方A帐号名/委托名。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p103289702013"><a name="zh-cn_topic_0221482426_p103289702013"></a><a name="zh-cn_topic_0221482426_p103289702013"></a>委托方A的帐号信息。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p33286718209"><a name="zh-cn_topic_0221482426_p33286718209"></a><a name="zh-cn_topic_0221482426_p33286718209"></a>委托方A的帐号ID。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0221482426_p1328574209"><a name="zh-cn_topic_0221482426_p1328574209"></a><a name="zh-cn_topic_0221482426_p1328574209"></a>委托方A的帐号名称。</p>
</td>
</tr>
</tbody>
</table>
...
示例1：由被委托方B（帐号名为IAMDomainB）中的IAM用户B（用户名IAMUserB，请求头中的X-Auth-Token字段需要填写IAMUserB的用户token，且该token需要具有Agent Operator权限），获取委托方A（帐号名为IAMDomainA）创建的委托名为IAMAgency，作用范围为委托方A整个帐号的token。

示例2：由被委托方B（帐号名为IAMDomainB）中的IAM用户B（用户名IAMUserB，请求头中的X-Auth-Token字段需要填写IAMUserB的用户token，且该token需要具有Agent Operator权限），获取委托方A（帐号名为IAMDomainA）创建的委托名为IAMAgency，作用范围为委托方A的项目“cn-north-1”，且返回的响应体中将不显示catalog信息的token。
