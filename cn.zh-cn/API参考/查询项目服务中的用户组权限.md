# 查询项目服务中的用户组权限<a name="zh-cn_topic_0057845640"></a>

## 功能介绍<a name="zh-cn_topic_0222037485_section8600152723314"></a>

该接口可以用于[管理员](https://support.huaweicloud.com/usermanual-iam/zh-cn_topic_0079496985.html)查询项目服务中的用户组权限。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0222037485_p11602927123314"><a name="zh-cn_topic_0222037485_p11602927123314"></a><a name="zh-cn_topic_0222037485_p11602927123314"></a>用户组ID，获取方式请参见：<a href="获取IAM用户-项目-用户组-委托的名称和ID.md">获取IAM用户、项目、用户组、委托的名称和ID</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0222037485_p560462733314"><a name="zh-cn_topic_0222037485_p560462733314"></a><a name="zh-cn_topic_0222037485_p560462733314"></a>项目ID，获取方式请参见：<a href="获取IAM用户-项目-用户组-委托的名称和ID.md">获取IAM用户、项目、用户组、委托的名称和ID</a>。</p>
</td>
</tr>
</tbody>
</table>
