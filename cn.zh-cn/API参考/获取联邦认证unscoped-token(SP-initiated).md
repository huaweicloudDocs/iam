...
```
1.在浏览器的地址栏输入并跳转链接：https://iam.myhuaweicloud.com/v3/OS-FEDERATION/identity_providers/ACME/protocols/saml/auth
2.该链接可打开身份提供商认证页面，根据需要输入匹配规则的用户名（密码可以不写），跳入认证页面打开F12,点击认证页面的accept。
