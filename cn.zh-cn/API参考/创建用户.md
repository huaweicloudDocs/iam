# 创建用户<a name="zh-cn_topic_0057845637"></a>

## 功能介绍<a name="s5888597838b0425a92e3419fb766c7f5"></a>

该接口用于在华为云账号下创建IAM用户，IAM用户首次登录时需要修改密码。
...
-   Request Body参数说明
    ...
    <tr id="row44921145112313"><td class="cellrowborder" valign="top" width="22.13%" headers="mcps1.1.5.1.1 "><p id="p3493194592314"><a name="p3493194592314"></a><a name="p3493194592314"></a>description</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="37.38%" headers="mcps1.1.5.1.4 "><p id="p134931945102313"><a name="p134931945102313"></a><a name="p134931945102313"></a>用户的描述信息。</p>
    </td>
    </tr>
    </tbody>
    </table>
